...
public class HostPanelController {
   ...
   public static void btnNext0Controller(DefaultMutableTreeNode node1,JTree tree_1, HostPanel configurationPanel,JPanelForInputPathSetting inputPathPanel) {
	...
	public static String jcomboBoxItemController(ItemEvent ie,JComboBox jcomboBoxConfiguration,HostPanel configurationPanel,JPanelForInputPathSetting inputPathPanel,
		...
		return handler(jcomboBoxConfiguration,configurationPanel, inputPathPanel, populationPanel, genePanel, functionPanel, myConfigurationFromDB, configurationsOfHistory, myGepService);
   }
	...
	public static String btnChangeConfigController(JComboBox jcomboBoxConfiguration,HostPanel configurationPanel,JPanelForInputPathSetting inputPathPanel,
    ...
    public static String handler(JComboBox jcomboBoxConfiguration,HostPanel configurationPanel,JPanelForInputPathSetting inputPathPanel,
    		JPanelForPopulation populationPanel,JPanelForGene genePanel,JPanelForFunction functionPanel,GepConfiguration myConfigurationFromDB,List<GepConfiguration> configurationsOfHistory,
    		IgepAlgService myGepService){
		...
		jcomboBoxConfiguration.setSelectedItem(myConfigurationFromDB.getName());
		...
		return jcomboBoxConfiguration.getSelectedItem().toString();
    }
